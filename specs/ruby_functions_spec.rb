...
class Functions_Practice < MiniTest::Test
  ...
  def test_volume_of_cube()
    cube_volume_result = volume_of_cube(3)
    assert_equal(27, cube_volume_result)
  end

  #Given the radius of a sphere calculate the volume
  def test_volume_of_sphere()
    sphere_volume_result = volume_of_sphere(3)
    assert_equal(113, sphere_volume_result)
  end

  #Given a value in farenheit, convert this into celsius.
  def test_fahrenheit_to_celsius()
    temp_conversion_result = fahrenheit_to_celsius(40)
    assert_equal(4.44, temp_conversion_result)
  end
